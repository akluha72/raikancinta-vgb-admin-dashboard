...
CREATE TABLE `events` (
  ...
  `gallery_pin` varchar(10) DEFAULT NULL,
...
CREATE TABLE `guestbook_entries` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_guestbook_event` (`event_id`),
  CONSTRAINT `fk_guestbook_event` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
